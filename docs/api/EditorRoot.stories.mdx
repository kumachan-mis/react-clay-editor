...
| taggedLinkPropsMap | { [tagName: string]: EditorTaggedLinkProps } | no       | `{}` (see also <LinkTo kind="api-editorroot--page#editortaggedlinkprops">EditorTaggedLinkProps</LinkTo>) | map of tag names to configurations of tagged links |
