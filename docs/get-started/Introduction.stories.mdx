...
To answer these verious needs, React Clay Editor offers some choices. Users can apply format by syntactic writing. At
the same time, users can do this by selecting text and clicking buttons in the syntax menu. The editor toggles between
the view mode and edit the mode in-place. On the other hand, the viewer is available to implement a dual-paned editor.
