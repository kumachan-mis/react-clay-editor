...
You can implement a range of editors by compounding components -
`EditorRoot`, `EditorTextFieldRoot`, `EditorTextFieldHeader`, `EditorTextFieldBody`, `EditorSyntaxMenu`
and your own ones.
